      ...
      <div className="bg-white border border-gray-200 rounded-[8px] p-4 shadow-card flex flex-col md:flex-row items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-4 py-2 bg-slate-50 border border-gray-200 rounded-[6px] text-xs focus:outline-none focus:border-[#1D6FA4]"
          />
        </div>
        ...
        <div className="flex items-center space-x-3 w-full md:w-auto">
          ...
          <select
            ...
            className="bg-slate-50 border border-gray-200 rounded-[6px] px-3 py-1.5 text-xs text-gray-800 font-sans focus:outline-none focus:border-[#1D6FA4]"
          >
